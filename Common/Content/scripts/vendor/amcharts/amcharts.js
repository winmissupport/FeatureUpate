...
AmCharts.ValueAxis = AmCharts.Class({
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) g = !0;
                ...
                if (0 < y) {
                    ...
                    for (d = this.fillAlpha = 0; d < y; d++) {
                        ...
                        var I = NaN;
                        isNaN(E.value) || (I = this.getCoordinate(E.value), t = new this.axisItemRenderer(this, I, E.label, !0, NaN, (A - I) / 2, E), this.pushAxisItem(t,
                            z));
                        isNaN(A - I) || (t = new this.guideFillRenderer(this, I, A, E), this.pushAxisItem(t, z), t = t.graphics(), E.graphics = t, E.balloonText && this.addEventListeners(t, E))
                    }
                    this.fillAlpha = c
                }
                w = !1;
                    ...
                    if (n =
                        ...
                        if (isNaN(u) || Number(AmCharts.toFixed(n, u)) == n) {
                            ...
                            if (n == this.baseValue && "radar" != a.type) {
                                ...
                                t = this.viX;
                                E = this.viY;
                                "H" == this.orientation ? 0 <= c && c <= z + 1 && (B = [c, c, c + e], K = [A, 0, f]) : 0 <= c && c <= A + 1 && (B = [0, z, z + e], K = [c, c, c + f]);
    ...
    stackGraphs: function (a) {
        ...
        if (s && ("regular" == b || "100%" == b))
            for (p = 0; p < h.length; p++) m = h[p], m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis ==
    ...
    getMinMax: function () {
        ...
        if (this.includeGuidesInMinMax && 0 < a)
            for (b = 0; b < a; b++) c =
                this.guides[b], c.toValue < this.min && (this.min = c.toValue), c.value < this.min && (this.min = c.value), c.toValue > this.max && (this.max = c.toValue), c.value > this.max && (this.max = c.value);
        ...
        "100%" == this.stackType && (this.min = 0 > this.min ? -100 : 0, this.max = 0 > this.max ?
            0 : 100);
        c = this.max - this.min;
...
AmCharts.RecItem = AmCharts.Class({
    construct: function (a, b, c, d, e, f, g, h, k, l) {
        ...
        var r = a.axisThickness,
            ...
            $ = a.offset,
            ra, P;
        g ? (G = !0, isNaN(g.tickLength) || (t = g.tickLength), void 0 != g.lineColor && (E = g.lineColor), void 0 != g.color && (n = g.color), isNaN(g.lineAlpha) || (w = g.lineAlpha), isNaN(g.dashLength) || (A = g.dashLength), isNaN(g.lineThickness) || (y = g.lineThickness), !0 === g.inside && (N = !0), isNaN(g.labelRotation) || (B = g.labelRotation), isNaN(g.fontSize) || (p = g.fontSize), g.position && (ia = g.position)) : "" === c && (t = 0);
        P = "start";
        e && (P = "middle");
        var Y = B * Math.PI / 180,
            pa, H = 0,
        ...
        "V" == Na && (B = 0);
        var x;
        G && (x = a.autoWrap && 0 === B ? AmCharts.wrappedText(s, c, n, m, p, P, h, e, 0) : AmCharts.text(s, c, n, m, p, P, h), P = x.getBBox(), da = P.width, ja = P.height);
        if ("H" == Na) {
            if (0 <= b && b <= X + 1 && (0 < t && 0 < v && b + k <= X + 1 && (ra = AmCharts.line(s, [b + k, b + k], [0, t], u, v, y), q.push(ra)), 0 < w && (P = AmCharts.line(s, [b, b + ca, b + ca], [U, U + W, W], E, w, y, A), q.push(P))), F = 0, H = b, g && 90 == B && (H -= p), !1 === d ? (P = "start", F = "bottom" == ia ? N ? F + t : F - t : N ? F - t : F + t, H += 3, e && (H += e / 2, P = "middle"), 0 < B && (P = "middle")) : P =
                "middle", 1 == K && 0 < I && !g && !l && ma < X && (d = AmCharts.fitToBounds(b, 0, X), ma = AmCharts.fitToBounds(ma, 0, X), pa = d - ma, 0 < pa && (fill = AmCharts.rect(s, pa, a.height, z, I), fill.translate(d - pa + ca, W), q.push(fill))), "bottom" == ia ? (F += U + p / 2 + $, N ? 0 < B ? (F = U - da / 2 * Math.sin(Y) - t - 3, H += da / 2 * Math.cos(Y) - 4 + 2) : 0 > B ? (F = U + da * Math.sin(Y) - t - 3 + 2, H += -da * Math.cos(Y) - ja * Math.sin(Y) - 4) : F -= t + p + 3 + 3 : 0 < B ? (F = U + da / 2 * Math.sin(Y) + t + 3, H -= da / 2 * Math.cos(Y)) : 0 > B ? (F = U + t + 3 - da / 2 * Math.sin(Y) + 2, H += da / 2 * Math.cos(Y)) : F += t + r + 3 + 3) : (F += W + p / 2 - $, H += ca, N ? 0 < B ? (F = da / 2 * Math.sin(Y) +
                    t + 3, H -= da / 2 * Math.cos(Y)) : F += t + 3 : 0 < B ? (F = -(da / 2) * Math.sin(Y) - t - 6, H += da / 2 * Math.cos(Y)) : F -= t + p + 3 + r + 3), "bottom" == ia ? pa = (N ? U - t - 1 : U + r - 1) + $ : (V = ca, pa = (N ? W : W - t - r + 1) - $), f && (H += f), W = H, 0 < B && (W += da / 2 * Math.cos(Y)), x && (ia = 0, N && (ia = da / 2 * Math.cos(Y)), W + ia > X + 2 || 0 > W)) x.remove(), x = null
        } else {
            0 <= b && b <= U + 1 && (0 < t && 0 < v && b + k <= U + 1 && (ra = AmCharts.line(s, [0, t], [b + k, b + k], u, v, y), q.push(ra)), 0 < w && (P = AmCharts.line(s, [0, ca, X + ca], [b, b + W, b + W], E, w, y, A), q.push(P)));
            P = "end";
            if (!0 === N && "left" == ia || !1 === N && "right" == ia) P = "start";
            F = b - p / 2;
            1 ==
                K && 0 < I && !g && !l && (d = AmCharts.fitToBounds(b, 0, U), ma = AmCharts.fitToBounds(ma, 0, U), Y = d - ma, fill = AmCharts.polygon(s, [0, a.width, a.width, 0], [0, 0, Y, Y], z, I), fill.translate(ca, d - Y + W), q.push(fill));
            F += p / 2;
            "right" == ia ? (H += ca + X + $, F += W, N ? (H -= t + 4, f || (F -= p / 2 + 3)) : (H += t + 4 + r, F -= 2)) : N ? (H += t + 4 - $, f || (F -= p / 2 + 3), g && (H += ca, F += W)) : (H += -t - r - 4 - 2 - $, F -= 2);
            ra && ("right" == ia ? (V += ca + $ + X, pa += W, V = N ? V - r : V + r) : (V -= $, N || (V -= t + r)));
            f && (F += f);
            N = -3;
            "right" == ia && (N += W);
            x && (F > U + 1 || F < N) && (x.remove(), x = null)
        }
...
AmCharts.AmChart = AmCharts.Class({
    ...
    initChart: function () {
        ...
        this.container = a;
        if (AmCharts.VML || AmCharts.SVG) a = this.container, this.set = a.set(), this.gridSet = a.set(), this.cursorLineSet = a.set(), this.graphsBehindSet = a.set(), this.bulletBehindSet = a.set(), this.columnSet = a.set(), this.graphsSet = a.set(), this.trendLinesSet = a.set(), this.axesLabelsSet = a.set(), this.axesSet = a.set(),
            this.cursorSet = a.set(), this.scrollbarsSet = a.set(), this.bulletSet = a.set(), this.freeLabelsSet = a.set(), this.balloonsSet = a.set(), this.balloonsSet.setAttr("id", "balloons"), this.zoomButtonSet = a.set(), this.linkSet = a.set(), this.renderFix()
    },
    measure: function () {
        var a = this.div;
        if (a) {
            ...
            this.balloon.chart = this;
            if (a != this.previousWidth ||
                f != this.previousHeight) b.style.width = a + "px", b.style.height = f + "px", e && e.setSize(a, f);
    ...
    addListeners: function () {
        var a = this,
            b = a.chartDiv;
        document.addEventListener ? (a.panEventsEnabled && "ontouchstart" in document.documentElement &&
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function () {
        ...
        var l = this.width,
            ...
            u = [],
            v = [],
            t, w, y, E, A = this.chart.graphs.length,
            z, I = this.dx / this.depthCount,
        ...
        if (!W && ("line" == g || "smoothedLine" == g || "step" == g) && (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), Oa || void 0 != Da)) {
            ...
            n ? (eb = m, fb = Math.abs(yb -
                Aa), hb = m, ib = Math.abs($a - Aa), Za = gb = 0, f.reversed ? (Xa = 0, Ya = Aa) : (Xa = Aa, Ya = 0)) : (fb = l, eb = Math.abs(yb - Aa), ib = l, hb = Math.abs($a - Aa), Ya = Xa = 0, f.reversed ? (Za = p, gb = Aa) : Za = Aa + 1)
        }
        var Ba = Math.round;
        this.pmx = Ba(Xa);
        this.pmy = Ba(gb);
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < N) {
                for (J = N - 1; -1 < J; J--)
                    if (ja = d[J],
                        x = ja.axes[f.id].graphs[b], Wa = x.values.value, !isNaN(Wa)) {
                        N = J;
                        break
                    }
            ...
            if (ca <
                ...
                for (J = ca + 1; J < d.length; J++)
                    if (ja = d[J], x = ja.axes[f.id].graphs[b], Wa = x.values.value, !isNaN(Wa)) {
                        ca = J;
                        break
                    }
        }
        ...
        var Q = [],
            ...
            Ea = !1;
        if ("line" == g || "step" == g || "smoothedLine" == g)
            if (this.stackable && "regular" == B || "100%" == B || this.fillToGraph) Ea = !0;
        ...
        for (J = N; J <= ca; J++) {
            ...
            if (ua) {
                ...
                if ("candlestick" == g || "ohlc" == g) Z = ua.close, kb = ua.low, va = f.getCoordinate(kb), jb = ua.high, wa = f.getCoordinate(jb);
                na = ua.open;
                C = f.getCoordinate(Z);
                isNaN(na) || (L =
                    f.getCoordinate(na));
                ...
                var ka = ja.x[Na.id],
                    ...
                    xa = la,
                    Ab = 0;
                "left" == this.stepDirection && (Ab = (2 * V + Ka * V) / 2, ka -= Ab);
                "start" == this.pointPosition && (ka -= V / 2 + Math.floor(Ka * V / 2), la = 0, xa = Math.floor(V) + Math.floor(Ka * V));
                "end" == this.pointPosition && (ka += V / 2 + Math.floor(Ka * V / 2), la = Math.floor(V) + Math.floor(Ka * V), xa = 0);
                if (zb) {
                    var lb = this.columnWidth;
                    isNaN(lb) || (la *= lb, xa *= lb)
                }
                W || (x.x = ka); -1E5 > ka && (ka = -1E5);
                ka > l + 1E5 && (ka = l + 1E5);
                n ? (D = C, M = L, L = C = ka, isNaN(na) && !this.fillToGraph && (M = ia), Fa = va, Ga = wa) : (M = D = ka, isNaN(na) && !this.fillToGraph && (L = ia));
                ...
                switch (g) {
                    case "line":
                        if (isNaN(Z)) r || (this.drawLineGraph(u, v, Q, R), u = [], v = [], Q = [], R = []);
                            ...
                            ea = D;
                            fa = C;
                            !Ea || isNaN(L) || isNaN(M) || (Q.push(M),
                                R.push(L));
                            void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(u, v, Q, R), u = [D], v = [C], Q = [], R = [], !Ea || isNaN(L) || isNaN(M) || (Q.push(M), R.push(L)), this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength);
                    ...
                    case "smoothedLine":
                        if (isNaN(Z)) r || (this.drawSmoothedGraph(u, v, Q, R), u = [], v = [], Q = [], R = []);
                            ...
                            if (Math.abs(D - ab) >= cb || Math.abs(C - bb) >=
                                cb) u.push(D), v.push(C), ab = D, bb = C;
                            ba = D;
                            ha = C;
                            ea = D;
                            fa = C;
                            !Ea || isNaN(L) || isNaN(M) || (Q.push(M), R.push(L));
                            void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawSmoothedGraph(u, v, Q, R), u = [D], v = [C], Q = [], R = [], !Ea || isNaN(L) || isNaN(M) || (Q.push(M), R.push(L)), this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength);
                    ...
                    case "step":
                        if (!isNaN(Z)) {
                            if (x.isNegative = Z < ma ? !0 : !1, void 0 ==
                                x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(u, v, Q, R), u = [], v = [], Q = [], R = [], this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength), n ? (isNaN(t) || (u.push(t), v.push(C - la)), v.push(C - la), u.push(D), v.push(C + xa), u.push(D), !Ea || isNaN(L) || isNaN(M) || (Q.push(y), R.push(L - la), Q.push(M), R.push(L - la), Q.push(M), R.push(L + xa))) : (isNaN(w) || (v.push(w), u.push(t), v.push(w), u.push(D - la)), u.push(D - la), v.push(C), u.push(D + xa), v.push(C), !Ea ||
                                    isNaN(L) || isNaN(M) || (Q.push(M - la), R.push(E), Q.push(M - la), R.push(L), Q.push(M + xa), R.push(L))), t = D, w = C, y = M, E = L, ba = D, ha = C, ea = D, fa = C, zb || x.gap) t = w = NaN, this.drawLineGraph(u, v, Q, R), u = [], v = [], Q = [], R = []
                        } else if (!r) {
                            if (1 >= this.periodSpan || 1 < this.periodSpan && D - t > la + xa) t = w = NaN;
                    ...
                    case "column":
                        ...
                        if (!isNaN(Z)) {
                            ...
                            if (!(Z < Bb && na < Bb ||
                                Z > Cb && na > Cb))
                                if (n) {
                                    "3d" == B ? (T = C - .5 * (h + F) + F / 2 + G * U, S = M + I * U) : (T = Math.floor(C - (s / 2 - U) * (h + F) + F / 2), S = M);
                                    O = h;
                                    ba = D;
                                    ha = T + h / 2;
                                    ea = D;
                                    ...
                                    if (T < m && 0 < O && (qa = new AmCharts.Cuboid(e, aa, O, I - a.d3x, G - a.d3y, Ca, Ra, X, oa, $, H, q, n, P, Sa), "bottom" != K && "inside" != K && "middle" != K))
                                        if (K = f.reversed ? "left" : "right", 0 > Z) K = f.reversed ? "right" : "left";
                                        else if ("regular" == B || "100%" == B) ba += this.dx
                                } else {
                                    "3d" == B ? (S =
                                        D - .5 * (h + F) + F / 2 + I * U, T = L + G * U) : (S = D - (s / 2 - U) * (h + F) + F / 2, T = L);
                                    O = h;
                                    ba = S + h / 2;
                                    ha = C;
                                    ea = S + h / 2;
                                    ...
                                    if (S < l + U * I && 0 < O)
                                        if (qa = new AmCharts.Cuboid(e, O, aa, I - a.d3x, G - a.d3y, Ca, Ra, X, oa, this.lineAlpha, H, q, n, P, Sa), 0 > Z && "middle" != K && "inside" != K) K = "bottom";
                                        else if (K = pa, "regular" == B || "100%" == B) ha += this.dy
                                }
                            if (qa && (ta = qa.set, ta.translate(S, T), this.columnsSet.push(ta), (x.url || this.showHandOnHover) &&
                                ta.setAttr("cursor", "pointer"), !W)) {
                                "none" == B && (z = n ? (this.end + 1 - J) * A - c : A * J + c);
                                "3d" == B && (n ? (z = (A - c) * (this.end + 1 - J), ba += I * this.columnIndex, ea += I * this.columnIndex, x.y += I * this.columnIndex) : (z = (A - c) * (J + 1), ba += 3, ha += G * this.columnIndex + 7, fa += G * this.columnIndex, x.y += G * this.columnIndex));
                                if ("regular" == B || "100%" == B) "inside" != K && (K = "middle"), z = n ? 0 < ua.value ? (this.end + 1 - J) * A + c : (this.end + 1 - J) * A - c : 0 < ua.value ? A * J + c : A * J - c;
                    ...
                    case "candlestick":
                        if (!isNaN(na) && !isNaN(Z)) {
                            ...
                            void 0 != x.lineColor && (oa = x.lineColor);
                            if (n) {
                                if (T = C - h / 2, S = M, O = h, T + O > m && (O = m - T), 0 > T && (O += T, T = 0), T < m && 0 < O) {
                                    var nb, ob;
                                    Z > na ? (nb = [D, Ga], ob = [M, Fa]) : (nb = [M, Ga], ob = [D, Fa]);
                                    !isNaN(Ga) && !isNaN(Fa) && C < m && 0 < C && (db = AmCharts.line(e, nb, [C, C], oa, $, X), mb = AmCharts.line(e, ob, [C, C], oa, $, X));
                                    aa = D - M;
                                ...
                                var qa = new AmCharts.Cuboid(e, O, aa, I, G, Ca, Ra, X, oa, $, H, q, n, P, Sa),
                                    pb, qb;
                                Z > na ? (pb = [C, wa], qb = [L, va]) : (pb = [L, wa], qb = [C, va]);
                                !isNaN(wa) && !isNaN(va) && D < l && 0 < D && (db = AmCharts.line(e, [D, D], pb, oa, $, X), mb = AmCharts.line(e, [D, D], qb, oa, $, X))
                            }
                            qa && (ta = qa.set, Y.push(ta), ta.translate(S, T - X / 2), (x.url || this.showHandOnHover) && ta.setAttr("cursor", "pointer"), db && (Y.push(db), Y.push(mb)), ba = D, ha = C, n ? (fa = C, ea = D, "open" == k && (ea = M), "high" == k && (ea = Ga), "low" == k && (ea = Fa)) : (fa = C, "open" == k && (fa = L), "high" == k && (fa = wa), "low" ==
                                k && (fa = va), ea = D), W || (x.x = n ? T + O / 2 : S + O / 2, this.animateColumns(qa, J, D, M, C, L), this.addListeners(ta, x)))
                        }
                        break;
                    case "ohlc":
                        if (!(isNaN(na) || isNaN(jb) || isNaN(kb) || isNaN(Z))) {
                            ...
                            if (n) {
                                ...
                                sb = AmCharts.line(e, [M, M], [ub, Db], sa, $, X, P);
                                0 < C && C < m && (rb = AmCharts.line(e, [Fa, Ga], [C, C], sa, $, X, P));
                                ...
                                0 < D && D < l && (rb = AmCharts.line(e, [D, D], [va, wa], sa, $, X, P));
                ...
                if (!W && !isNaN(Z)) {
                    ...
                    if (this.end - this.start <= Fb || 0 === Fb) {
                        var Ha =
                            this.createBullet(x, ea, fa, J);
                        Ha || (Ha = 0);
                        var Gb = this.labelText;
                        if (Gb) {
                            var ga = this.createLabel(x, 0, 0, Gb),
                                ya = 0,
                                za = 0,
                                Hb = ga.getBBox(),
                                La = Hb.width,
                            ...
                            switch (K) {
                                ...
                                case "right":
                                    ...
                                    break;
                                case "bottom":
                                    n && "column" == g ? (ba = ia, 0 > Z || 0 < Z && f.reversed ? (ya = -6, ga.attr({
                                        "text-anchor": "end"
                                    })) : (ya = 6, ga.attr({
                                        "text-anchor": "start"
                                    }))) : (za = Ha / 2 + Ia / 2, ga.x = -(La / 2 + 2));
                                    break;
                                case "middle":
                                    "column" == g && (n ? (za = -(Ia / 2) + this.fontSize / 2, ya = -(D - M) / 2 - I, 0 > aa && (ya += I), Math.abs(D - M) < La && !this.showAllValueLabels && (ga.remove(), ga = null)) : (za = -(C - L) / 2, 0 > aa && (za -= G), Math.abs(C - L) < Ia && !this.showAllValueLabels && (ga.remove(), ga = null)));
                                    break;
                                case "inside":
                                    n ? (za = -(Ia / 2) + this.fontSize / 2, ya = 0 > aa ? La / 2 + 6 : -La / 2 - 6) : za = 0 > aa ? Ia : -Ia
                            }
                            if (ga) {
                                if (isNaN(ha) || isNaN(ba)) ga.remove(), ga = null;
                                else if (ba += ya, ha += za, ga.translate(ba, ha), n) {
                                    if (0 > ha || ha > m) ga.remove(), ga = null
                                } else {
                                    var Ib = 0;
                                    "3d" == B && (Ib = I * U);
                                    if (0 > ba || ba > l + Ib) ga.remove(), ga = null
                                }
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? this.drawSmoothedGraph(u, v, Q, R) : this.drawLineGraph(u,
            v, Q, R), W || this.launchAnimation();
    ...
    drawLineGraph: function (a, b, c, d) {
        ...
        if (1 < a.length) {
            ...
            if (0 < f || 0 < v)
                if (m = a.join(";").split(";"), n = b.join(";").split(";"), "serial" == e.chart.type && (0 < c.length ? (c.reverse(), d.reverse(), m = a.concat(c), n = b.concat(d)) : e.rotate ? (n.push(n[n.length - 1]), m.push(t), n.push(n[0]), m.push(t), n.push(n[0]), m.push(m[0])) : (m.push(m[m.length - 1]), n.push(t), m.push(m[0]), n.push(t), m.push(a[0]), n.push(n[0]))), a = e.gradientRotation, 0 < f && (b = AmCharts.polygon(g, m, n, s, f, 1, "#000", 0, a), b.pattern(e.pattern),
                    h.push(b)), u || void 0 !== q) isNaN(v) && (v = f), u || (u = q), g = AmCharts.polygon(g, m, n, u, v, 1, "#000", 0, a), g.pattern(e.pattern), k.push(g), k.click(function (a) {
                        e.handleGraphEvent(a, "clickGraph")
                    }).mouseover(function (a) {
                        e.handleGraphEvent(a, "rollOverGraph")
                    }).mouseout(function (a) {
    ...
    animateGraphs: function () {
        ...
        b && (this.rotate ? (b.translate(-1E3,
            e), c.translate(-1E3, e)) : (b.translate(d, -1E3), c.translate(d, -1E3)), b.animate({
                opacity: 1,
                translate: d + "," + e
            }, f, a), c.animate({
                opacity: 1,
    ...
    createBullet: function (a, b, c, d) {
        ...
        if (this.customBullet || a.customBullet) n = this.customBullet, a.customBullet && (n = a.customBullet), n && (p && p.remove(), "function" == typeof n ? (p = new n, p.chart = this.chart, a.bulletConfig && (p.availableSpace = c, p.graph = this,
            a.bulletConfig.minCoord = this.minCoord - c, p.bulletConfig = a.bulletConfig), p.write(d), p = p.set) : (this.chart.path && (n = this.chart.path + n), p = d.set(), d = d.image(n, 0, 0, f, f), p.push(d), this.centerCustomBullets && d.translate(-f / 2, -f / 2)));
    ...
    handleRollOver: function (a, b) {
        if (a) {
            ...
            if (d) {
                var d = c.formatString(this.balloonText,
                        a, !0),
    ...
    handleRollOut: function (a, b) {
        ...
        if (a) {
            ...
            this.chart.fire("rollOutGraphItem",
                c)
        }
    ...
    detectMovement: function () {
        ...
        if (a.mouseIsOver) {
            var b = a.mouseX - this.x,
                c = a.mouseY - this.y; -.5 < b && b < this.width + 1 && 0 < c && c < this.height ? (this.drawing ? this.rolledOver || a.setMouseCursor("crosshair") : this.pan && (this.rolledOver || a.setMouseCursor("move")), this.rolledOver = !0, this.setPosition()) : this.rolledOver && (this.handleMouseOut(), this.rolledOver = !1)
        ...
        if (this.enabled) {
            ...
            if (s) {
                var q = s.x[g.id],
                    ...
                    G = c.graphs,
                    B = g.axisThickness;
                if (c.mouseIsOver || z || I || this.forceShow)
                    if (this.forceShow = !1, I) {
                        ...
                        0 !== e && (h = {
                            type: "zoomed",
                            target: this
                        }, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (c + e > y && (e = y - c), z + e < w && (e = w - z), h.start = Math.round(z + e), h.end = Math.round(c + e), this.fire(h.type, h)) : K + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = K + e, this.fire(h.type, h)))
                    } else {
                        "start" ==
                        ...
                        if (r) {
                            ...
                            0 < v && !this.zooming ? isNaN(this.previousX) ? N.translate(w, y) : (N.translate(this.previousX, this.previousY), N.animate({
                                translate: w +
                                    "," + y
                            }, v, "easeOutSine")) : N.translate(w, y);
                            this.previousX = w;
                            this.previousY = y;
                            N.show()
                        }
                        this.linePos = r ? q + k : q;
                        z && (d && N.hide(), r ? this.updateSelectionSize(NaN, q) : this.updateSelectionSize(q, NaN));
                        v = !0;
                        z && (v = !1);
                        this.categoryBalloonEnabled && v ? (r ? (u && ("right" == A ? t.setBounds(l, m + k, l + p + h, m + q + k) : t.setBounds(l, m + k, l + p + h, m + q)), "right" == A ? u ? t.setPosition(l + p + h, m + q + k) : t.setPosition(l + p + h + B, m + q + k) : u ? t.setPosition(l, m + q) : t.setPosition(l - B, m + q)) : "top" == A ? u ? t.setPosition(l + q + h, m + k) : t.setPosition(l + q + h, m + k - B + 1) : u ? t.setPosition(l +
                        ...
                        if (this.oneBalloonOnly) {
                            k = Infinity;
                            for (t = 0; t < G.length; t++) g = G[t], g.showBalloon && !g.hidden && g.balloonText && (w = s.axes[g.valueAxis.id].graphs[g.id],
                                    ...
                                    if (g = G[t], (!this.oneBalloonOnly || g == K) && g.showBalloon && !g.hidden && g.balloonText && ("step" == g.type && "left" == g.stepDirection &&
                                        ...
                                        if (this.showNextAvailable && isNaN(y) && a + 1 < this.data.length)
                                            for (k = a + 1; k < this.data.length; k++)
                                                if (q = this.data[k])
                                                    if (w = q.axes[g.valueAxis.id].graphs[g.id], y = w.y, !isNaN(y)) break;
                                        if (!isNaN(y)) {
                                            q = w.x;
                                            u = !0;
                                            if (r) {
                                            ...
                                            u && (1 != this.graphBulletSize && AmCharts.isModern && (u = w.bulletGraphics) && (u.getBBox(), u.translate(w.bx, w.by, this.graphBulletSize), this.resizedBullets.push(w)), u = g.valueBalloon, A = c.getBalloonColor(g,
                                                w), u.setBounds(l, m, l + p, m + n), u.pointerOrientation = "H", B = this.balloonPointerOrientation, "vertical" == B && (u.pointerOrientation = "V"), "horizontal" == B && (u.pointerOrientation = "H"), u.changeColor(A), void 0 !== g.balloonAlpha && (u.fillAlpha = g.balloonAlpha), void 0 !== g.balloonTextColor && (u.color = g.balloonTextColor), u.setPosition(k + l, q + m), k = c.formatString(g.balloonText, w, !0), (q = g.balloonFunction) && (k = q(w, g).toString()), "" !== k && (r ? u.showBalloon(k) : (u.text = k, u.show = !0)), !r && u.set && u.set.hide(), v.push({
                                                    yy: y,
                                                    balloon: u
                                                }))
                                        }
                        ...
                        b ? (h = {
                            type: "changed"
                        }, h.index = a, h.chart = this.chart, h.zooming = z, h.mostCloseGraph = K, h.position = r ? f : e, h.target = this, c.fire("changed", h), this.fire("changed", h), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
    ...
    draw: function () {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                var A = this.minWidth,
                    z = "";
                isNaN(A) || (z = "min-width:" + (A - 2 * q) + "px; ");
                m.innerHTML =
                    '<div style="text-align:' + this.textAlign + "; " + z + "max-width:" + this.maxWidth + "px; font-size:" + y + "px; color:" + this.color + "; font-family:" + w + '">' + this.text + "</div>";
                ...
                "H" != v ? (A = a - z / 2, b < h + w + 10 && "down" != v ? (I = !0, d && (b += y), y = b + u, this.deltaSignY = -1) : (d && (b -= y), y = b - w -
                    u, this.deltaSignY = 1)) : (2 * u > w && (u = w / 2), y = b - w / 2, a < g + (k - g) / 2 ? (A = a + u, this.deltaSignX = -1) : (A = a - z - u, this.deltaSignX = 1));
                y + w >= l && (y = l - w);
                y < h && (y = h);
                A < g && (A = g);
                A + z > k && (A = k - z);
                var h = y + r,
                    ...
                    B = this.bulletSize,
                    K;
                0 < t || 0 === u ? (0 < r && (a = AmCharts.rect(e, z, w, p, 0, q + 1, G, r, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), p = AmCharts.rect(e, z, w, p, this.fillAlpha, q, n, this.borderAlpha, this.cornerRadius), this.showBullet && (K = AmCharts.circle(e,
                    B, s, this.fillAlpha), f.push(K))) : (s = [], t = [], "H" != v ? (g = a - A, g > z - u && (g = z - u), g < u && (g = u), s = [0, g - u, a - A, g + u, z, z, 0, 0], t = I ? [0, 0, b - y, 0, 0, w, w, 0] : [w, w, b - y, w, w, 0, 0, w]) : (s = b - y, s > w - u && (s = w - u), s < u && (s = u), t = [0, s - u, b - y, s + u, w, w, 0, 0], s = a < g + (k - g) / 2 ? [0, 0, A < a ? 0 : a - A, 0, 0, z, z, 0] : [z, z, A + z > a ? z : a - A, z, z, 0, 0, z]), 0 < r && (a = AmCharts.polygon(e, s, t, p, 0, q, G, r), a.translate(1, 1), f.push(a)), p = AmCharts.polygon(e, s, t, p, this.fillAlpha, q, n, this.borderAlpha));
                this.bg = p;
                f.push(p);
                p.toFront();
                e = 1 * this.deltaSignX;
                ...
                this.bottom = y + w + 1;
                this.yPos = p.y + y;
                K && K.translate(this.pointToX - A + e, b - y);
...
AmCharts.AmCoordinateChart = AmCharts.Class({
    ...
    parseSerialData: function () {
        ...
        if (e) {
            ...
            for (q = 0; q < e.length; q++) {
                ...
                k && (v.forceShow = t[k]);
                s[t[d]] = v;
                if (f && (b = h.categoryFunction ? h.categoryFunction(b, t, h) : b instanceof Date ? AmCharts.newDate(b, h.minPeriod) : r ? AmCharts.stringToDate(b, r) : new Date(b), b = AmCharts.resetDateToMin(b, l, m, h.firstDayOfWeek), v.category = b, v.time = b.getTime(), isNaN(v.time))) continue;
                ...
                for (y = 0; y < w.length; y++) {
                    ...
                    for (A = 0; A < a.length; A++) {
                        ...
                        if (b.valueAxis.id == E) {
                            ...
                            !b.connect && u && u[z] && v.time - p[z] > 1.1 * n && (u[z].gap = !0);
        ...
        for (c =
            0; c < a.length; c++) b = a[c], b.dataProvider && this.parseGraphData(b)
    },
    ...
    removeValueAxesAndGraphs: function () {
        var a = this.valueAxes,
            b;
        for (b =
            a.length - 1; -1 < b; b--) this.removeValueAxis(a[b])
    },
    ...
    processGuides: function () {
        ...
        if (a)
            for (var c = 0; c < a.length; c++) {
                ...
                var e = d.valueAxis;
                e ? (AmCharts.isString(e) && (e = this.getValueAxisById(e)), e ? e.addGuide(d) : this.valueAxes[0].addGuide(d)) :
    ...
    formatString: function (a, b, c) {
        var d = b.graph,
            e = d.valueAxis;
        e.duration && b.values.value && (e = AmCharts.formatDuration(b.values.value,
            e.duration, "", e.durationUnits, e.maxInterval, e.numberFormatter), a = a.split("[[value]]").join(e));
...
AmCharts.AmSlicedChart = AmCharts.Class({
    ...
    pullInAll: function (a) {
        var b = this.chartData,
            c;
        for (c = 0; c < this.chartData.length; c++) c !=
    ...
    parseData: function () {
        ...
        if (void 0 !== b) {
            ...
            for (e = b = 0; e < c; e++) f = a[e], f.percents = f.value / d * 100, f.percents <
                this.groupPercent && b++;
            ...
            for (e = 0; e < a.length; e++) c ? g = AmCharts.adjustLuminosity(c, e * d / 100) : (g = this.colors[e],
    ...
    switch (b) {
        ...
        case "xError":
            p = a.set(), p.push(AmCharts.line(a, [-c /
                2, c / 2
            ], [0, 0], d, e, f)), p.push(AmCharts.line(a, [-c / 2, -c / 2], [-k, k], d, e, f)), p.push(AmCharts.line(a, [c / 2, c / 2], [-k, k], d, e, f))
    }
    p && p.pattern(m);
    return p
};
...
AmCharts.handDrawnLine = function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    for (m = 1; m < b.length; m++)
        for (var n = [b[m - 1], b[m]], s = [c[m - 1], c[m]], s = AmCharts.makeHD(n, s, a.handDrawScatter), n = s[0], s = s[1], q = 1; q < n.length; q++) p.push(AmCharts.line(a, [n[q - 1], n[q]], [s[q - 1], s[q]], d, e, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
    return p
};
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, p) {
    ...
    d = a.set();
    var G;
    q && (r = n(10 * r), t = n(10 * t), y = n(10 * y), A = n(10 * A), v = n(10 * v), w = n(10 * w), E = n(10 * E), u = n(10 * u), b = n(10 * b), k = n(10 * k), c = n(10 * c), f *= 10, g *= 10, h *= 10, s *= 10, 1 > Math.abs(e) && 1 >= Math.abs(y - t) && 1 >= Math.abs(E - w) && (G = !0));
    e = "";
    var B;
    p && (z["fill-opacity"] = 0, z["stroke-opacity"] = l["stroke-opacity"] / 2, z.stroke = l.stroke);
    0 < k && (q ? (B = " M" + r + "," + (v + k) + " L" + t + "," + (w + k), G || (B += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + t + "," + (w + k) + "," + y + "," + (E + k)), B += " L" + A + "," + (u + k), 0 < h && (G || (B += " B" + (b - h) + "," + (k + c - s) + "," + (b + h) + "," + (k + c + s) +
        "," + A + "," + (k + u) + "," + r + "," + (k + v)))) : (B = " M" + r + "," + (v + k) + " L" + t + "," + (w + k) + (" A" + f + "," + g + ",0," + I + ",1," + y + "," + (E + k) + " L" + A + "," + (u + k)), 0 < h && (B += " A" + h + "," + s + ",0," + I + ",0," + r + "," + (v + k))), B += " Z", B = a.path(B, void 0, void 0, "1000,1000").attr(z), d.push(B), B = a.path(" M" + r + "," + v + " L" + r + "," + (v + k) + " L" + t + "," + (w + k) + " L" + t + "," + w + " L" + r + "," + v + " Z", void 0, void 0, "1000,1000").attr(z), k = a.path(" M" + y + "," + E + " L" + y + "," + (E + k) + " L" + A + "," + (u + k) + " L" + A + "," + u + " L" + y + "," + E + " Z", void 0, void 0, "1000,1000").attr(z), d.push(B), d.push(k));
    q ? (G || (e = " A" + n(b - f) + "," + n(c - g) + "," + n(b + f) + "," + n(c + g) + "," + n(t) + "," + n(w) + "," + n(y) + "," + n(E)), f = " M" + n(r) + "," + n(v) + " L" + n(t) + "," + n(w) + e + " L" + n(A) + "," + n(u)) : f = " M" + r + "," + v + " L" + t + "," + w + (" A" + f + "," + g + ",0," + I + ",1," + y + "," + E) + " L" + A + "," + u;
    0 < h && (q ? G || (f += " B" + (b - h) + "," + (c - s) + "," + (b + h) + "," + (c + s) + "," + A + "," + u + "," + r + "," + v) : f += " A" + h + "," + s + ",0," + I + ",0," + r + "," + v);
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    arrangeEntries: function () {
        ...
        for (t = 0; t < u.length; t++) {
            var A = u[t];
            this.reversedOrder && (A = u[u.length - t - 1]);
            v = A.getBBox();
            var z;
            this.equalWidths ? z = f + y * (n + m + this.markerLabelGap) : (z = E, E = E + v.width + f + m);
            z + v.width > p && 0 < t && 0 !== y && (w++, y = 0, z = f, E = z + v.width + f + m);
            A.translate(z, (s + l) * w);
            y++;
            !isNaN(k) && y >= k && (y = 0, w++);
            q.push(A)
        ...
        k = v.height + 2 * l - 1;
        "left" == a || "right" ==
            a ? (h = v.width + 2 * f, g.style.width = h + b + c + "px") : h = h - b - c - 1;
    ...
    createEntry: function (a) {
        if (!1 !==
            ...
            if (this.useGraphSettings)
                if (m = a.type, this.switchType = void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m) g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR),
                    p = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(p), a.bullet && (a.hidden || (d = a.bulletColorR), p = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (p.translate(l + 1, l / 2), g.push(p)), n = 0, m = l, p = l / 3;
                else {
                    var s;
                ...
                (h = b.path + h), g = k.image(h, 0, 0, l, l)) : (g = this.createMarker(c, d, e, void 0, void 0, void 0, void 0, g)) && g.translate(l / 2, l / 2);
    ...
    clickMarker: function (a) {
        this.switchable && (!0 === a.hidden ? this.dispatch("showItem", a) : this.dispatch("hideItem",
            a));
    ...
    createValue: function (a) {
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            if (b.valueText && 0 < b.valueWidth) {
                var f = b.color;
                b.useMarkerColorForValues && (f = a.color, a.legendKeyColor &&
                    (f = a.legendKeyColor()));
