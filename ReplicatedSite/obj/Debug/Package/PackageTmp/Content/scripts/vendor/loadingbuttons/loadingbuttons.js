 ...
 * Modified heavily by Travis Wilson with Exigo
 */
(function (t, e) {
...
/*!
 * LoadingButtons 0.8.0 (2013-09-05, 18:54)
...
(function (t, e) {
    "object" == typeof exports ? module.exports = e() : "function" == typeof define && define.amd ? define(["spin"], e) : t.LoadingButtons = e(t.Spinner)
})(this, function (t) {
    "use strict";

    function e(t) {
        if (t === void 0) return console.warn("LoadingButtons button target must be defined."), void 0;
        ...
        var $t = $(t);
        if (typeof ($t.attr('data-style')) === "undefined") $t.attr('data-style', 'zoom-in');
        var r, a = {
            start: function () {
...
/*!
 * LoadingButtons Widget Wrapper 1.0.0
 *
 * Copyright (C) 2014 Hakim Travis Wilson with Exigo 
 *
 * Usage: $('#mybutton').loadingbutton('start');
 */
$.simpleWidget('loadingbutton', {
    options: {            
    },
    _create: function () {
        LoadingButtons.bind(this.element[0]);
    },
    start: function () {            
        var button = LoadingButtons.create(this.element[0]);
        button.start();
    },
    stop: function () {
        var button = LoadingButtons.create(this.element[0]);
