...
namespace Common.Services
{
    public static class Greeking
    {
        ...
        public static string Number
        {
            get
            {
                return Index.Next(1, 99999).ToString("N0");
            }
        }
        public static string Percent
        {
            get
            {
                return Index.Next(1, 100).ToString("N0");
            }
        }
        public static string Money
        {
            get
            {
                return Index.Next(1, 9999).ToString("C");
            }
        }
        public static string RoundedMoney
        {
            get
            {
                return Index.Next(1, 9999).ToString("C0");
            }
        }
        #endregion
